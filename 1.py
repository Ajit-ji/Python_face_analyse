...
image_files = [f for f in glob.glob(r'E:\Face_analyse\gender_dataset_face' + "/**/*", recursive=True) if not os.path.isdir(f)]
...
def build(width, height, depth, classes):
    ...
    model.add(Input(shape=inputShape))  # Add Input layer here
...
# Compile the model
opt = Adam(learning_rate=lr)  # Updated optimizer
